...
Для тестирования функций разных групп пользователей мы предлагаем вам воспользоваться аккаунтами "Обычного" пользователя - Логин: RegularUser; Пароль: 12345; "Премиум" пользователя - Логин: PremiumUser; Пароль: 12345.
##### Ссылки:
